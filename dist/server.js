...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nvar index_1 = __webpack_require__(/*! ../index */ \"./src/server/db/index.ts\");\nvar findOne = function (id, token) { return index_1.knextion('tokens').select().where({ id: id, token: token }); };\nvar insertToken = function (userid) { return index_1.knextion('tokens').insert({ userid: userid }); };\nvar updateToken = function (id, token) { return index_1.knextion('tokens').update({ token: token }).where({ id: id }); };\nexports.default = {\n    findOne: findOne,\n    insertToken: insertToken,\n    updateToken: updateToken\n};\n\n\n//# sourceURL=webpack:///./src/server/db/queries/tokens.ts?");
